...
namespace RentHive.Controllers
{
    public class HomeController : Controller
    {
        ...
        //----------------------------------------start of code-----------------------------------------------
        public async Task<IActionResult> Report_Details (UserDataGetter TempData)
        {
            var userData = HttpContext.Session.GetString("UserData");
            if (string.IsNullOrEmpty(userData))
            {
        ...
        //----------------------------------------start of code-----------------------------------------------
        public async Task<IActionResult> UserVerification(UserDataGetter TempData,string ErrorMessage)
        {
            var userData = HttpContext.Session.GetString("UserData");
            if (string.IsNullOrEmpty(userData))
            {
